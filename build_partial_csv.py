#!/usr/bin/env python3
"""Build an interim CSV from whatever raw_results/*.json files exist so far,
using the same matching logic as blinkit_audit.py, without touching the
in-progress background run."""
import csv
import json
from pathlib import Path

from blinkit_audit import SKUS, LOCATIONS, pick_best
...
out_path = Path(__file__).parent / "blinkit_audit_results_partial.csv"
